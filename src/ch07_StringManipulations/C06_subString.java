...
public class C06_subString {
    public static void main(String[] args) {
        ...
        System.out.println("str.startsWith(10) = " + str.substring(0,10));
        System.out.println("str.substring(0,1) = " + str.substring(0,1));

        String strr="abcd";
        System.out.println(strr.substring(3,4)+strr.substring(2,3)+strr.substring(1,2)+strr.substring(0,1));
