...
/* indexOf()
      ...
      */
        ...
        System.out.println("str.indexOf(\"a\") = " + str.indexOf("is"));
 ...
 */
        ...
        System.out.println("bir özlü söz gir");

        String soz = input.nextLine().toLowerCase();

        if (soz.indexOf("java") == -1) {
            System.out.println("java yok");
        } else if (soz.indexOf("java") == soz.lastIndexOf("java")) {
            System.out.println("java bir tane");
        } else System.out.println("java birden fazla");
