...
public class C09_replace_replaceAll {
    public static void main(String[] args) {
        ...
        System.out.println("str.replaceFirst(\"e\", \"x\") = " + str.replaceFirst("e", "x"));

        System.out.println("str.replaceAll(\"\\\\w\", \"*\") = " + str.replaceAll("\\w", "*"));
        System.out.println("str.replaceAll(\"\\\\w\", \"*\") = " + str.replaceAll("\\W", "*"));
        System.out.println("str.replaceAll(\"\\\\w\", \"*\") = " + str.replaceAll("[A-Za-z]", "*"));
...
// isim-soyisim : M***** B*******
// kart no : **** **** **** 1234
        String isim="Meryem",soyisim="Hanım",kartNo="1234567891234567";
        ...
        String yeniKartNoRegex=kartNo.substring(0,12).replaceAll("[0-9]","*")+kartNo.substring(12,16);
