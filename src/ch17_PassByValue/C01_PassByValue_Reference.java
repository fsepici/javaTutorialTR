...
veya mobilyalarında değişiklik yapar. Bu değişiklikler doğrudan
 ...
 evinize etki eder.
        ...
        incrementInt(x);
        System.out.println("method call sonrası x değeri " + x);
        changeString(s);
        System.out.println("method call sonrası x değeri " + s);
        // task -> verilen fiyat için %24 artırılmış fiyatı print eden method
// create ediniz.
        double fiyat = 100;
        fiyatKdv(fiyat);
        System.out.println("method call sonrası x değeri " + fiyat);
    }

    private static void fiyatKdv(double fiyat) {
        fiyat*=1.24;
        System.out.println("method içinden fiyat = " + fiyat);
    }

    private static void changeString(String s) {
        s="world";
        System.out.println("method içindens = " + s);
    }

    private static void incrementInt(int x) {
        x += 10;
        System.out.println("increment method call sonrası x değeri " + x);
